...
- Generated at: 2026-06-22T22:07:24.328Z
- Mobile commit SHA: b92d976ffbfeaabfd0325c14931dca53d0502df1
- Mobile worktree status: dirty: 52 modified, 7 untracked
- Backend commit SHA: 6565a21514261444e9fed278296ef0e27b678e93
- Backend worktree status: dirty: 14 modified, 3 untracked
- Target environment: production
- Evidence decision: BLOCKED_EXTERNAL_DEPENDENCY
- Evidence limitations: provider evidence not supplied; production smoke, backup/restore, delete, paywall, privacy/Sentry, compliance, rollback, remote CI, Android runtime, live self-hosted RC workflow evidence, and production rollout authorization are not verified in this local packet; C5C/C5D add local telemetry runtime evidence only and do not change RC readiness
